...
{block name='content'}
	...
	<form class="form-horizontal" action="{current_url()}" method="post">
		<fieldset>
			...
			<!-- Form Name -->
			<legend><h4>Edit paket</h4></legend>
			
			<!-- Text input-->
			<div class="form-group">
				<label class="col-lg-2 control-label" for="textinput">Nama Paket</label>  
				<div class="col-lg-6">
					<input name="nama_paket" placeholder="Nama paket" class="form-control input-md" type="text" value="{$data->nama_paket}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-2">
					<input name="jumlah" placeholder="Jumlah soal" class="form-control input-md" type="text" value="{$data->jumlah}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-2">
					<input name="biaya" placeholder="Biaya" class="form-control input-md" type="text" value="{$data->biaya}">
				</div>
			</div>
