...
{block name='content'}
	...
	<form class="form-horizontal" action="{current_url()}" method="post">
		<fieldset>
			...
			<!-- Form Name -->
			<legend><h4>Edit Jadwal Tes</h4></legend>

			<!-- Text input-->
			<div class="form-group">
				<label class="col-lg-2 control-label" for="tanggal_test">Tanggal Tes</label>  
				<div class="col-lg-2">
					<input id="tanggal_test" name="tanggal_test" class="form-control input-md" type="text" required="" value="{$jadwal_test->tanggal_test|date_format:"%d/%m/%Y"}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<select id="id_form_soal" name="id_form_soal" class="form-control" required="">
						...
						{html_options options=$form_soal_set selected=$jadwal_test->id_form_soal}
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-2">
					<input id="biaya" name="biaya" class="form-control input-md" type="text" required="" value="{$jadwal_test->biaya}">
				</div>
			</div>
