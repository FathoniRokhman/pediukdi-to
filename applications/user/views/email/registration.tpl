...
<html>
	...
	<body>
		<div id="container">
			...
			<p><strong>Terima kasih {if isset($nama)}{$nama}{/if}, anda baru saja mendaftar di <a href="http://www.pediukdi.com">PEDI-UKDI</a>.</strong></p>
			<p>Berikut ini informasi <i>account</i> anda :</p>
			<ul>
				<li>Email : <code>{if isset($email)}{$email}{/if}</code></li>
